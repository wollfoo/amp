 ...
 **12 servers enabled** (see `.config/amp/settings.json` for detailed config):
 ...
 - `playwright` — Browser automation (headless, isolated)
 - `everything` — General-purpose sandbox MCP
 - `semgrep` — Static analysis & security scanning
 - `sourcegraph` — Multi-repo code search
